...
<div class="page-content">
      ...
      <div class="page-header no-margin-bottom">
        <div class="container-fluid">
          <h2 class="h5 no-margin-bottom">Genres Edit Table</h2>
        </div>
      </div>
      ...
      <div class="col-lg-12">
            <div class="block">
              <div class="title"><strong>Edit Genres Data</strong></div>
                ...
                <form class="form-horizontal">
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          ...
                          <img src="{{asset('backend-assets/img/genres/01.jpg')}}" alt="photo" class="mt-3" width="150">
                        </div>
                      </div>
                  <div class="form-group row">
