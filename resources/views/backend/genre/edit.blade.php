            ...
            <div class="block-body">
              <form class="form-horizontal">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="name" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{$genre->name}}">
                    @if ($errors->has('name'))
                ...
                <div class="form-group row">
                  <div class="col-sm-9 ml-auto">
                      <button type="submit" class="btn btn-primary"> <i class="fa fa-floppy-o" aria-hidden="true"></i> Upsate </button>
                  </div>
                </div>
              </form>
            </div>
